...
# Configuration
SOURCE_DIRS = [f"output-{i}" for i in range(6)]
TARGET_IMG_DIR = "merged_images"
TARGET_MD_FILE = "merged_output.md"
        ...
        for source_dir in SOURCE_DIRS:
            ...
            for filename in files:
                ...
                def replace_image_link(match):
                    ...
                    # New filename to avoid collisions: output-X_originalName.jpg
                    new_filename = f"{source_dir}_{img_filename}"
                ...
                def replace_html_img(m):
                    ...
                    if src_match:
                        ...
                        new_name = f"{source_dir}_{filename}"
